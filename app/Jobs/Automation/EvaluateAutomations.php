...
/**
 * Async worker for user automations. One job per event (not per rule) so
 * the dispatcher can leverage queue batching and a single attempt covers
 * all of a user's rules. System reactions already ran synchronously in
 * the dispatcher; this job is purely the user-rule layer.
 */
